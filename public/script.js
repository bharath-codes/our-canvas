window.addEventListener('load', () => {
    ...
    // ... (All other setup and element selections are the same)
    ...
    // ... (THE REST OF YOUR DRAWING AND CURSOR CODE IS EXACTLY THE SAME)
    ...
    brushSizeSlider.addEventListener('input', (e) => { currentBrushSize = e.-value; brushSizeDisplay.textContent = e.target.value; });
    ...
    canvas.addEventListener('touchstart', startDrawing, { passive: false }); canvas.addEventListener('touchmove', handleMouseMove);
